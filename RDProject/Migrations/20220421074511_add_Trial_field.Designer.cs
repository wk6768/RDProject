...
namespace RDProject.Migrations
{
    ...
    [Migration("20220421074511_add_Trial_field")]
    partial class add_Trial_field
    {
            ...
            modelBuilder.Entity("RDProject.Models.Trial", b =>
                {
                    ...
                    b.Property<DateTime>("FCreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 21, 15, 45, 11, 567, DateTimeKind.Local).AddTicks(455));
            ...
            modelBuilder.Entity("RDProject.Models.WFInstance", b =>
                {
                    ...
                    b.Property<DateTime>("SubTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 21, 15, 45, 11, 558, DateTimeKind.Local).AddTicks(162));
