...
namespace RDProject.Migrations
{
    ...
    [Migration("20220420054241_add_WFStep_field")]
    partial class add_WFStep_field
    {
            ...
            modelBuilder.Entity("RDProject.Models.Trial", b =>
                {
                    ...
                    b.Property<DateTime>("FCreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 20, 13, 42, 41, 143, DateTimeKind.Local).AddTicks(5365));
            ...
            modelBuilder.Entity("RDProject.Models.WFInstance", b =>
                {
                    ...
                    b.Property<DateTime>("SubTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 20, 13, 42, 41, 133, DateTimeKind.Local).AddTicks(5370));
